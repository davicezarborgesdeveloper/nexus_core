...
import 'package:nexus_core/src/modules/portfolio/pages/main/widgets/language/menu_language_enum.dart';
      ...
      builder: (context, controller, child) {
        return Material(
          ...
          child: InkWell(
            ...
            child: Row(
              children: [
                const Icon(Icons.language, color: ColorManager.secondary),
